...
# Asset paths: shipped artifacts live under src/fedzk/zk/ (NOT zk/circuits/build/)
ZK_ASSET_DIR = Path(__file__).resolve().parent.parent / "zk"
STD_WASM_DEFAULT = str(ZK_ASSET_DIR / "model_update.wasm")
STD_ZKEY_DEFAULT = str(ZK_ASSET_DIR / "proving_key.zkey")
SEC_WASM_DEFAULT = str(ZK_ASSET_DIR / "model_update_secure.wasm")
SEC_ZKEY_DEFAULT = str(ZK_ASSET_DIR / "proving_key_secure.zkey")
STD_VER_KEY_DEFAULT = str(ZK_ASSET_DIR / "verification_key.json")
SEC_VER_KEY_DEFAULT = str(ZK_ASSET_DIR / "verification_key_secure.json")
